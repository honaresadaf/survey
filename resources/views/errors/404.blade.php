...
<body class="has-rtl nk-body ui-rounder npc-general pg-error no-touch nk-nio-theme" dir="rtl">
                ...
                <div class="nk-block nk-block-middle wide-md mx-auto">
                    <div class="nk-block-content nk-error-ld text-center">
                        ...
                        <div class="wide-xs mx-auto">
                            ...
                            <a href="{{ route('welcome') }}" class="btn btn-lg btn-primary mt-2">بازگشت به صفحه اصلی</a>
                        </div>
                    </div>
                </div>
                <!-- .nk-block -->
